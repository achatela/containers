...
int main(void){
	...
	// VECTOR TESTS
	{
		...
		ft::vector<int> vct_default;
		ft::vector<int> vct_fill(100, 100);
		ft::vector<int> vct_assign_it;
		ft::vector<int> vct_assign_size;
		ft::vector<int> vct_cpy(vct_fill);
		...
		ft::vector<int> vct_assign_op = vct_assign_size;
		...
		ft::vector<int> vct_range_construct(vct_default.begin(), vct_default.end());
...

	{
		...
		ft::vector<std::string> vct_str;
		ft::vector<std::string> vct_fill_str(10, "FILL CONSTRUCTOR");
		ft::vector<std::string> vct_empty;

		std::cout << "vct_fill_str iterator:" << std::endl;
		for (ft::vector<std::string>::iterator it = vct_fill_str.begin(); it != vct_fill_str.end(); it++){
			std::cout << "it: " << *it << " ";
		...
		for (ft::vector<std::string>::const_iterator it = vct_fill_str.begin(); it != vct_fill_str.end(); it++){
			std::cout << "it: " << *it << " ";
			vct_str.push_back(*it);
		}
		std::cout << "size: " << vct_fill_str.size() << std::endl << std::endl;
		...
		for (ft::vector<std::string>::reverse_iterator rit = vct_str.rbegin(); rit != vct_str.rend(); rit++){
			std::cout << "rit: " << *rit << " ";
		}
		std::cout << "size: " << vct_str.size() << std::endl << std::endl;

		std::cout << "vct_str const_reverse_iterator:" << std::endl;
		for (ft::vector<std::string>::const_reverse_iterator rit = vct_str.rbegin(); rit != vct_str.rend(); rit++){
			std::cout << "rit: " << *rit << " ";
		}
		std::cout << "size: " << vct_str.size() << std::endl << std::endl;

		std::cout << "vct_empty iterator:" << std::endl;
		for (ft::vector<std::string>::iterator it = vct_empty.begin(); it != vct_empty.end(); it++){
...

	{
		...
		ft::vector<char> vct_char(255, 42);
		ft::vector<char> vct_to_assign;
...

	{
		...
		for (ft::vector<int>::iterator it = vct_cpy.begin(); it != vct_cpy.end(); it++){
			std::cout << *it << " ";
		}
	}
	...
	{
		ft::map<std::string, int> map_default;
		...
		map_default.insert(ft::pair<std::string, int>("Coucou", 123));
		map_default.insert(ft::pair<std::string, int>("123", 123));
		map_default.insert(ft::pair<std::string, int>("Test", 543));
		map_default.insert(ft::pair<std::string, int>("FOO", 987));
		map_default.insert(ft::pair<std::string, int>("BAR", 1230989));

		std::cout << "Map_default empty: " << map_default.empty() << std::endl;
		std::cout << "Map_default size: " << map_default.size() << std::endl;

		ft::map<std::string, int> map_insert;
		ft::map<std::string, int> map_cpy(map_default);
		ft::map<std::string, int> map_assign = map_cpy;
		...
		ft::map<std::string, int>::iterator it = map_cpy.begin();
		ft::map<std::string, int>::iterator it1 = map_default.begin();
		ft::map<std::string, int>::iterator it3 = map_assign.begin();
		for (ft::map<std::string, int>::iterator it2 = map_insert.begin(); it2 != map_insert.end(); it2++){
		...
		ft::map<std::string, int>::const_reverse_iterator rit = map_cpy.rbegin();
		ft::map<std::string, int>::const_reverse_iterator rit1 = map_default.rbegin();
		ft::map<std::string, int>::const_reverse_iterator rit3 = map_assign.rbegin();
		for (ft::map<std::string, int>::iterator rit2 = map_insert.begin(); rit2 != map_insert.end(); rit2++){
		...
		std::cout << "map_cpy.empty:" << map_cpy.empty() << std::endl;
		for (ft::map<std::string, int>::const_iterator cit = map_cpy.begin(); cit != map_cpy.end(); cit++){
	...
	// 	ft::vector<int> vct(2000000, 12345);
	// 	ft::vector<int> vct_cpy(vct);
