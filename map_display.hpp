...
# define __NIL		NULL		 // name of your NULL pointer
# define __RIGHT	rightChild	 // name of the right child of your nodes
# define __LEFT		leftChild	 // name of the left child of your nodes
...
void print_tree(__NODE *ptr, int level = 0, bool is_right = 0)
{
	...
	if (ptr != __NIL)
	{
		...
		if (ptr->__IS_BLACK)
			std::cout << __BLACK << ptr->__VALUE.first << __STOP;
		else
			std::cout  << __RED << ptr->__VALUE.first << __STOP;
